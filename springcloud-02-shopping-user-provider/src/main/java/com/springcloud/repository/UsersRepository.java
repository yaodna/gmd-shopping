...
public interface UsersRepository extends JpaRepository<Users, Integer>, JpaSpecificationExecutor<Users> {
	...
	@Query("select new com.springcloud.entity.Users(u.userId,u.userName,u.userNumber,"
			+ " u.userPassword,u.userSex,u.userPhone,u.userSite,u.userBirthday,"
			+ "u.userEmail,u.userPhoto,u.jdictionId,u.userStatus) "
			+ "from com.springcloud.entity.Users u where u.userId=:userId and u.userPassword=:userPassword and "
			+ "u.jdictionId=:jdictionId and u.userStatus=0")
	...
	@Query("update Users u set u.userNumber=:#{#users.userNumber},u.userSex=:#{#users.userSex},u.userPhone=:#{#users.userPhone},"
			+ "u.userBirthday=:#{#users.userBirthday},u.userEmail=:#{#users.userEmail},u.userSite=:#{#users.userSite}"
